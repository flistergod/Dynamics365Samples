...
export class Slider implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	// Power Apps component framework delegate which will be assigned  to this object which would 
	//be called whenever any update happens.
	...
	// This element contains all elements of our code component
	 ...
	 */
	 ...
	 public init(
		...
		this.labelElement.setAttribute("id", "lrclabel1");
